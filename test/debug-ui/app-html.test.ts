...
describe('ACA debug UI static contracts', () => {
    ...
    it('derives relevant session rows without zero-turn or stale-active noise', () => {
        ...
        const sessions = [
            {
                ...
                workspaceRoot: '/home/example/projects/anothercodingagent',
            ...
            },
            {
                ...
                workspaceRoot: '/home/example/projects/other',
                hasErrors: false,
            },
        ];
        ...
        expect(rows[0]).toMatchObject({
            ...
            workspaceKey: '/home/example/projects/anothercodingagent',
        });
    });
    ...
    it('search matches IDs, workspace, status, model, errors, and witness names', () => {
        ...
        const row = {
            ...
            subtitle: '1777345046-1 - /home/example/projects/anothercodingagent - 1:05 PM',
            status: 'degraded',
            workspaceKey: '/home/example/projects/anothercodingagent',
